...
<div class="container my-4">
    <div class="row g-3">
        ...
        <div class="col-md-6 right-section">
            ...
            <h6 class="text-center mt-3">تاريخ اَخر تحديث لأسعار الأسهم {{$lastStockDate->updated_at->timezone('Asia/Riyadh')->format('Y-m-d')}} الوقت :
                {{$lastStockDate->updated_at->timezone('Asia/Riyadh')->format('H:m A')}}</h6>
