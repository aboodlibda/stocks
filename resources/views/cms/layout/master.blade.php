                    ...
                    <div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
                        ...
                        <div class="w-100 hover-scroll-overlay-y d-flex pe-3" id="kt_aside_menu_wrapper"
                            ...
                            <div
                                ...
                                <!--begin:Menu item-->
                                <div class="menu-item ">
                                    <a class="menu-link" href="{{ route('sector-data') }}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
											<span class="svg-icon svg-icon-5">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <span class="menu-title">{{'بيانات القطاعات'}}</span>
                                    </a>
                                </div>
                                <!--end:Menu item-->
                                ...
                                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-250px"
                                    ...
                                    <form data-kt-search-element="form"
                                        ...
                                        <input type="text" class="form-control bg-transparent ps-13 fs-7 h-40px"
                                               name="search" value=""
                                               placeholder="{{trans('dashboard_trans.Quick Search')}}"
                                                ...
                                                <div class="scroll-y mh-200px mh-lg-350px">
                                                    ...
                                                    <a href="#"
                                                       class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <span
                                                                class="fs-6 fw-semibold">Si-Fi Project by AU Themes</span>
                                                    ...
                                                    <a href="#"
                                                       class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <span
                                                                class="fs-6 fw-semibold">Shopix Mobile App Planning</span>
                                                    ...
                                                    <a href="#"
                                                       class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <span
                                                                class="fs-6 fw-semibold">Dashboard Analitics Launch</span>
                    ...
                    <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div class="container d-flex flex-column flex-md-row flex-stack">
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6">Abdullah
                                    Yousuf</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
