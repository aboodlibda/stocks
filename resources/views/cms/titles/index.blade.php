...
@section('title','كافة العناوين')
@section('content')
    <!--begin::Page title-->
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">العناوين</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">العناوين</li>
                        ...
                        <tr data-note-id="1">
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="ms-5">
                                        <a href="{{route('titles.edit')}}" class="text-gray-800 text-hover-primary fs-5 fw-bold">{{'كافة العناوين'}}</a>
                                    </div>
                                </div>
                            </td>
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{route('titles.edit')}}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
{{--                                    <div class="menu-item px-3">--}}
