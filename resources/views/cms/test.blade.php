...
<div class="main_search_div">
    ...
    <table id="stock_table" class="table-container">
        ...
        <tr>
            ...
            <th colspan="2" class="row2-mergedAll gr-blue-2">Earning Ratios</th>
        ...
        <tr>
            ...
            <th class="row3-cell12 gr-blue-3">Daily Expected Return</th>
    ...
    function getCompanies() {
        $.ajax({
           ...
           <td style="background-color: ${color}">
            ...
            <td>
               <span style="font-weight: bold; color: ${company.avg_daily_expected_stock_return < 0 ? 'red' : 'black'}">${'% ' + company.avg_daily_expected_stock_return}</span>
           </td>
