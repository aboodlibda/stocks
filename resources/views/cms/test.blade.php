...
<script>
    ...
    function getCompanies() {
        $.ajax({
           ...
           <td>
               <span style="font-weight: bold; color: ${company.averageDailyExpectedReturn1Year < 0 ? 'red' : 'black'}">${company.averageDailyExpectedReturn1Year !== null ? '% ' + Number(company.averageDailyExpectedReturn1Year).toFixed(2) : 'N/A'}</span>
           </td>
