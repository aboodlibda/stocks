...
<div id="stock-section" class="container py-3">
    ...
    <div id="kpi" class="mt-4">
{{--        <div class="form-group">--}}
{{--            <label for="">View Chart Analysis For: </label>--}}
{{--            <select name="chart_type" id="chart_type">--}}
{{--                <option value="stock_probability">احتماليات توزيع عوائد الأسهم</option>--}}
{{--                <option value="stock_index">Stock vs. Index Return</option>--}}
{{--                <option value="support_and_resistance">Support and Resistance Price Level</option>--}}
{{--            </select>--}}
{{--        </div>--}}
        <div class="row">
            <div class="col-lg-12">
