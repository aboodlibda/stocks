...
@section('title',trans('dashboard_trans.edit portfolio'))
@section('content')
    <!--begin::Page title-->
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        ...
        <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.edit portfolio')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    <!--end::Page title=-->
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            <!--begin::Form-->
            <form id="kt_ecommerce_edit_coupon_form" method="POST" action="{{route('portfolios.update',$portfolio->id)}}"  class="form d-flex flex-column flex-lg-row" data-kt-redirect="{{route('portfolios.edit',$portfolio->id)}}">
                @csrf
                @method('PUT')
                <!--begin::Main column-->
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name" class="form-control rounded-4 mb-2" placeholder="{{trans('dashboard_trans.Name')}}" value="{{$portfolio->name}}" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="investment_amount" class="form-control rounded-4 mb-2" placeholder="{{trans('dashboard_trans.Investment amount')}}" value="{{$portfolio->investment_amount}}" />
                                            <!--end::Input-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <select class="form-select mb-2" name="status" data-control="select2"   data-hide-search="true" data-placeholder="{{trans('dashboard_trans.Select an option')}}" id="kt_ecommerce_edit_coupon_status_select">
                                                <option></option>
                                                <option value="active" @selected($portfolio->status == 'active')>{{trans('dashboard_trans.Active')}}</option>
                                                <option value="inactive" @selected($portfolio->status == 'inactive')>{{trans('dashboard_trans.Inactive')}}</option>
                                            </select>
                                            <!--end::Select2-->
                                            <!--begin::Description-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{route('portfolios.index')}}" id="kt_ecommerce_edit_coupon_cancel" class="btn btn-light me-5">{{trans('dashboard_trans.Cancel')}}</a>
                        <!--end::Button-->
                        <!--begin::Button-->
...
@section('script')
    ...
    <script src="{{asset('assets/js/custom/edit_portfolio.js')}}"></script>
